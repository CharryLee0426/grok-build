...
run `/trace` in a session or `grok trace view <session-id>` from a shell. Add
`--html --open` for an offline browser report. See
[Agent Trace Explorer](27-agent-traces.md).
